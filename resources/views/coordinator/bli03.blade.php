    ...
    <div class="container-fluid px-4">
        ...
        <div class="row px-3">
            ...
            <form method="POST" id="pdf-form" action="{{ route('coordinator.pdf.upload') }}">
                ...
                @csrf
                @method('POST')
                <button type="submit" class="btn btn-purple">Generate SLI-03</button>
            </form>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#search-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('coordinator.searchli03') }}',
                    type: 'GET',
                    data: formData,
            ...
            function loadGeneratedStudents() {
                $.ajax({
                    url: '{{ route('coordinator.li03generated') }}',
                    type: 'GET',
                    success: function(response) {
            ...
            function loadNotGeneratedStudents() {
                $.ajax({
                    url: '{{ route('coordinator.li03notGenerated') }}',
                    type: 'GET',
                    success: function(response) {
