    ...
    <script>
        $(document).ready(function() {
            $('#search-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('coordinator.searchli02') }}',
                    type: 'GET',
                    data: formData,
            ...
            function loadGeneratedStudents() {
                $.ajax({
                    url: '{{ route('coordinator.li02generated') }}',
                    type: 'GET',
                    success: function(response) {
            ...
            function loadNotGeneratedStudents() {
                $.ajax({
                    url: '{{ route('coordinator.li02notGenerated') }}',
                    type: 'GET',
                    success: function(response) {
