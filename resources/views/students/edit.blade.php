    ...
    <div class="container-fluid px-4">
        ...
        <form action="{{ route('students.update', Auth::user()->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <!-- Change coordinator name dynamically -->
                {{-- <div>
                    <strong>Coordinator Test:</strong>
                    <input type="text" class="form-control" name="name" id="input2" readonly="readonly">
                </div> --}}
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="student_number" value="{{ Auth::user()->student_number }}" class="form-control"
    ...
    {{-- <script>
        ...
        $(document).ready(function() {
            $('#input1').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/update-input-value',
                    data: {
                        input_value: inputValue
                    },
                    success: function(data) {
                        $('#input2').val(data.updated_value);
                    }
                });
            });
        });
